...
const NodeSidebar = () => {
  ...
  return (
    ...
    className={cn("max-w-60 h-full overflow-hidden", isSidebarOpen ? 'w-60' : 'w-auto')}>
        ...
        >
            <div className={cn('flex items-center justify-start gap-2', isSidebarOpen && 'justify-center')}>   
            ...
            <BaseList data={sidebarOptions} onClickHandler={handleClick} isSidebarOpen={isSidebarOpen}/>
            {/* <div>fav</div> */}
        </div>
    </motion.div>
  )
